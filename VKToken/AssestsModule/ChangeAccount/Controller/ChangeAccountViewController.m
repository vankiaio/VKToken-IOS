...
- (NavigationView *)navView{
    if (!_navView) {
        ...
        _navView = [NavigationView navigationViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, NAVIGATIONBAR_HEIGHT) LeftBtnImgName:@"icon_back" title:titleStr rightBtnImgName:@"" delegate:self];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.changeAccountDataArrayType == ChangeAccountDataArrayTypeLocal) {
        ...
        WalletAccount *walletAccount = self.dataArray[indexPath.row];
        accountName = walletAccount.vktAccountName;
    }
