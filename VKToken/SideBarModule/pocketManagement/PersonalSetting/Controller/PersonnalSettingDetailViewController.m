...
- (NavigationView *)navView{
    if (!_navView) {
        _navView = [NavigationView navigationViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, NAVIGATIONBAR_HEIGHT) LeftBtnImgName:@"icon_back" title:VALIDATE_STRING(self.titleStr) rightBtnTitleName:NSLocalizedString(@"保存", nil)delegate:self];
