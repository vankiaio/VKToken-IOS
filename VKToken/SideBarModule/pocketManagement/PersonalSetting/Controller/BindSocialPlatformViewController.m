...
- (NavigationView *)navView{
    if (!_navView) {
        _navView = [NavigationView navigationViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, NAVIGATIONBAR_HEIGHT) LeftBtnImgName:@"icon_back" title:[self.socialPlatformType isEqualToString:@"wechat"] ? NSLocalizedString(@"绑定微信", nil): NSLocalizedString(@"绑定QQ", nil)rightBtnImgName:@"" delegate:self];
