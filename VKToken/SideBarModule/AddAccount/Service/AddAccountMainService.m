...
//    NSMutableArray *itemDetailArr = [NSMutableArray arrayWithObjects:NSLocalizedString(@"使用已有的VKT账号", nil), NSLocalizedString(@"支付费用创建新VKT账号", nil), NSLocalizedString(@"填写注册码免费创建VKT账号", nil), NSLocalizedString(@"不定期开放，敬请关注", nil), nil];
...
//    NSMutableArray *iconArr_BB = [NSMutableArray arrayWithObjects:@"import_account", @"pay_create_account", @"vip_create_account", @"free_create_account",nil];
    ...
    NSMutableArray *itemDetailArr = [NSMutableArray arrayWithObjects:NSLocalizedString(@"使用已有的VKT账号", nil), NSLocalizedString(@"创建自定义名称的VKT账号", nil), nil];
