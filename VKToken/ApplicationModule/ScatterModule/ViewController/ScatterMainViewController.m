...
- (WKWebView *)webView{
    if (!_webView) {
        ...
        if (@available(iOS 9.0, *)) {
            self.webView.customUserAgent = @"VKTokenIos"; //tokenpocket
        } else {
            // Fallback on earlier versions
        }
    }
...
-(void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message{
    ...
    if ([result[0] containsString:@"pair"]) {
        ...
        if ([result1_tojsonStr containsString:@"identityFromPermissions"] || [result1_tojsonStr containsString:@"authenticate"]
            ...
            [resultDict setObject:@"VKToken" forKey:@"name"];
            ...
            [accountDict setObject:@"vkt" forKey:@"blockchain"];
...
- (void)loadWebView{
    //https://dapp.newdex.io/    https://game.wizards.one/#/ https://app.dvktgames.com/en/slots/dvkt  https://pixelmaster.io/ https://www.xpet.io/
    NSString *requestStr;
