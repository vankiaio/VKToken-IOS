...
- (CGFloat)addView:(CGRect)rect withArray:(NSArray *)keyWordArray{
    ...
    for (int i = 0; i < self.wordArray.count; i++) {
        ...
        [wordBtn setTitleColor:[UIColor colorWithHexString:@"#808080"] forState:UIControlStateNormal];
        ...
        if (self.viewMode == PrivateKeyConfirmMode) {
            ...
            [wordBtn setTitleColor:[UIColor colorWithHexString:@"#333333"] forState:UIControlStateNormal];
...
- (void)clickPrivateButton:(UIButton *)sender{
    ...
    if (self.viewMode == PrivateKeyConfirmMode) {
        if (sender.isSelected) {
            ...
            [sender setTitleColor:[UIColor colorWithHexString:@"#808080"] forState:UIControlStateNormal];
        }else{
            sender.selected = YES;
            sender.backgroundColor = HEX_RGB_Alpha(0x79BAFF, 1);
