...
@interface VktPrivateKey()

@end


@implementation VktPrivateKey
...
- (instancetype)initVktPrivateKey
{
    ...
    if (self) {
        ...
        self.vktPrivateKey = [NSString stringWithUTF8String:base];
        ...
        b58enc(base, &len, result,37);
        self.vktPublicKey = [NSString stringWithFormat:@"VKT%@", [NSString stringWithUTF8String:base]];
    }
    return self;
}
